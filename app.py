...
from data.utils import LANGS, get_lang, set_lang, t, is_authed, login, logout, get_persona, recommended_path
...
# Home content (requires login? we allow viewing but encourage login)
...
if is_authed():
    ...
    labels = {
        "banking": t("menu_banking"),
        "insurance": t("menu_insurance"),
        "healthcare": t("menu_healthcare"),
        "taxation": t("menu_taxation"),
        "housing": t("menu_housing"),
        "transport": t("menu_transport"),
        "work": t("menu_work"),
        "life": t("menu_life"),
    }
